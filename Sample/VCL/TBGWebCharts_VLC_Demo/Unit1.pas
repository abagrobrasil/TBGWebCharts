      ...
      .HTML(
        ...
        .CardStyled
          .CardType(CardstyledIconRight)
            ...
            .Callback
              .MethodName('CallBack')
              .ParamValue('Card Usu�rios R$ 56,58')
            .&End
          .&End
        .&End
        .CardStyled
            ...
            .Scales
              .Axes
                .XAxe
                  .ScaleLabel
                    .Display(True)
                    .LabelString('Faturamento por M�s')
                  .&End
                .&End
                .YAxe
                  .ScaleLabel
        ...
        ._Div
          ...
          .Add(
            WebCharts1
              .ContinuosProject
                .Alerts
                  .Title('Vendas do M�s em Andamento')
                  .AlertsClass
                    .Primary
                  .&End
                .&End
                ...
                .&End
                .Alerts
                  .Title('Volume de Vendas Acima da M�dia')
                  .AlertsClass
                    .Success
                  .&End
                .&End
                .Alerts
                  .Title('Volume de Vendas Abaixo da M�dia')
                  .AlertsClass
                    .Danger
                  .&End
                .&End
                .Alerts
                  .Title('Volume de Vendas na M�dia')
                  .AlertsClass
                    .Warning
                  .&End
                .&End
                ...
                .&End
                .Alerts
                  .Title('Existem Vendas n�o Transmitidas')
                  .AlertsClass
                    .Dark
                  .&End
                .&End
    ...
    .NewProject
      ...
      .Rows
        ...
        ._Div
          ...
          .Add('<div class="box""> ' +
               '<span class="count_top">' +
               '  <i class="far fa-money-bill-alt"></i> Valor Pe�as ' +
               '</span>' +
        ...
        ._Div
          ...
          .Add('<div class="box" > ' +
               '<span class="count_top">' +
               '  <i class="fas fa-clock fa-1x"></i> Valor Servi�os ' +
               '</span>' +
        ...
        ._Div
          ...
          .Add('<div class="box"> ' +
               '<span class="count_top">' +
               '  <i class="fas fa-wrench"></i> Servi�o Terceiro ' +
               '</span>' +
