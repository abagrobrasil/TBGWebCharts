...
begin
  if not Assigned(FWebBrowser) then
    raise Exception.Create('Primeiro � preciso setar o WebBrowser');
...
begin
  if not Assigned(FWebBrowser) then
    raise Exception.Create('Para usar CallbackJS primeiro � preciso setar o WebBrowser');
...
begin
  ...
  if not Assigned(FWindowParent) then
    raise Exception.Create('Para usar Chromium, primeiro � preciso setar o FFMXWindowParent');
...
begin
  Result := Self;
  if not Assigned(FWindowParent) then
    raise Exception.Create('Para usar Chromium, primeiro � preciso setar o FCEFWindowParent');
